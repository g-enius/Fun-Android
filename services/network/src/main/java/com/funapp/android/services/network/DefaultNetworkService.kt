...
class DefaultNetworkService(
    ...
    private val allItems = listOf(
        ...
        Item("7", "Manual DI", "Manual dependency injection passes dependencies through constructors without any framework. It keeps the dependency graph explicit, avoids annotation processing, and gives full control over object lifetimes.", "Constructor-based dependency injection without frameworks", "DI", "magnifyingglass.circle", "teal", iosEquivalent = "ServiceLocator"),
